...
const PromoSection = () => {
  return (
    <div className="flex flex-col-reverse lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 flex flex-col text-center lg:text-left items-center lg:items-start justify-center gap-8.25 px-16.5 py-20 lg:py-0 lg:pr-32">
